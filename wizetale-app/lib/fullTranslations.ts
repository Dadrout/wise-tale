...
const translations: Record<Language, any> = {
  en: {
    ...
    pricingPremiumTitle: "Premium Storyteller",
    pricingPremiumPrice: "$9.99",
    pricingPremiumDesc: "Unlimited learning adventures",
    ...
    pricingPremiumButton: "Get Premium",
    ...
    registerSubtitle: "Enter your email below to create your account",
  ...
  ru: {
    ...
    pricingPremiumTitle: "Премиум-рассказчик",
    pricingPremiumPrice: "499₽",
    pricingPremiumDesc: "Безграничные учебные приключения",
    ...
    pricingPremiumButton: "Получить Премиум",
    ...
    pricingEducatorsTitle: "Педагогам и школам",
    pricingEducatorsDesc:
      "Специальные цены для учителей и учебных заведений",
    pricingEducatorsButton: "Получить скидку для педагога",
    pricingPopularBadge: "Самый популярный",
    // Testimonials
    testimonialsTitle: "Истории, которые вдохновляют",
    testimonialsSubtitle:
      "Узнайте, как Wizetale меняет учебный опыт для учеников и педагогов",
    testimonial1Name: "г-жа Сара Джонсон",
    testimonial1Role: "Учитель истории 8-го класса",
    testimonial1Quote:
      "Мои ученики теперь действительно в восторге от уроков истории! История о Римской империи полностью их увлекла.",
    ...
    testimonial3Quote:
      "Моя дочь ненавидела географию, а теперь просит еще историй о разных странах!",
    // CTA
    ctaTitle: "Готовы изменить обучение?",
    ctaSubtitle:
      "Присоединяйтесь к тысячам педагогов и учеников, которые делают обучение волшебным с Wizetale",
    ctaInputPlaceholder: "Введите ваш email",
    ctaButton: "Присоединиться к списку ожидания",
    ctaDisclaimer:
      "Получите ранний доступ и эксклюзивные обновления. Никакого спама.",
    // Footer
    footerSlogan:
      "Делаем гуманитарное образование волшебным с помощью ИИ-сторителлинга.",
    ...
    footerEducatorsTitle: "Педагогам",
    ...
    footerCopyright: "© 2025 Wizetale. Все права защищены. Сделано с ❤️ для учеников по всему миру.",
    // Register Page
    registerTitle: "Создать аккаунт",
    registerSubtitle: "Введите ваш email, чтобы создать аккаунт",
    registerEmailLabel: "Email",
    registerEmailPlaceholder: "m@example.com",
